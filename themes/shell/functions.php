...
/* ::: LOAD SCRIPTS ::::::::::::::::::::::::::::::::: */
    ...
    function load_my_scripts_yo() {
        if ( !is_admin() && !is_login_page() ) {
            ...
            // functions
                wp_register_script( 'functions', get_template_directory_uri().'/js/functions.js', array('jquery'),'1.1', true); // true loads functions in the footer
                wp_enqueue_script( 'functions' );

            // modernizr
                wp_register_script( 'modernizr', get_template_directory_uri().'/js/modernizr.custom.js',null,null,false); // false loads modernizr in the head
                wp_enqueue_script( 'modernizr' );
                
            // navigation
                wp_register_script( 'navigation', get_template_directory_uri().'/js/navigation.js',null,null,false); // false loads navigation in the head
