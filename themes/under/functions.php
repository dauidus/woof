<?php
/**
 * undermine functions and definitions
 *
 * @package undermine
 */
...
function under_setup() {
	 ...
	 * If you're building a theme based on undermine, use a find and replace
	...
	add_theme_support( 'custom-background', apply_filters( 'under_custom_background_args', array(
