...
function woof_customize_register( $wp_customize ) {
	...
	// image library tab
	require_once get_template_directory() . '/inc/customizer/extras/customizer-image-library/cil.php';


	
		/* moved to /inc/customizer/extras/customizer-image-library/cil.php
		// Logo Controls
...
// social icons
require_once get_template_directory() . '/inc/customizer/social-icons/social-icons.php';

// google fonts
require_once get_template_directory() . '/inc/customizer/google-fonts/gwfc.php';
