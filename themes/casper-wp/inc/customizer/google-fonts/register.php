...
function gwfc_register_customizer_options( $wp_customize ) {
	...
	$webfonts_array    		= file( get_template_directory() . '/inc/customizer/google-fonts/fonts.json' );
	...
	// font type list
	require get_template_directory() . '/inc/customizer/google-fonts/font-type-list.php';
