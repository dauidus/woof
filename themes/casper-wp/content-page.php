...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <header class="post-header">
        <?php if ( 'post' == get_post_type() ) : ?>
            <span class="post-meta"><?php dauid_posted_on(); ?> | <?php printf($category_list); if ( '' != $tag_list ) { _e('in', 'dauid'); } printf($tag_list); ?></span>
        <?php endif; ?>
	...
	<?php edit_post_link( __( 'Edit', 'dauid' ), '<footer class="entry-footer"><span class="edit-link">', '</span></footer>' ); ?>
</article><!-- #post-## -->